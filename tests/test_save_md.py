from lawcite.save.save_md import save_markdown
...
def test_save_markdown_law(tmp_path):
    paragraph_content = {
        (
            ...
            "9",
            "Stk. 1.",
        ): "Konkurrence- og Forbrugerstyrelsen kan efter anmeldelse fra en virksomhed eller sammenslutning af virksomheder erklære...",
        (
            "1",
            "9",
            "Stk. 2.",
